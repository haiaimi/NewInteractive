...
void TestProjectHelper::DeprojectScreenToWorld_Cursor(const AMainController* PlayerControl, FVector& OutWorldPos, FVector& OutWorldDir)
{
...
void TestProjectHelper::DeprojectScreenToWorld_SpecifyPoint(const AMainController* PlayerControl, FVector2D ScreenPos, FVector& OutWorldPos, FVector& OutWorldDir)
{
